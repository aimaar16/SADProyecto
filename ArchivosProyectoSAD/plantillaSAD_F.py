...
if __name__ == "__main__":
    config = load_config('config_T.json') #Cambiar JSON aquí (T --> TripAdvisor (1-5), A --> AirBnb (0,1))
    dataset_path = config.get("dataset")
    
    df = preproceso(dataset_path, 'config_T.json', 'processed_data.csv') #Cambiar JSON aquí también (T --> TripAdvisor (1-5), A --> AirBnb (0,1))
